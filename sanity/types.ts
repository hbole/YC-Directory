...
export type FETCH_STARTUP_VIEWS_QUERYResult = {
  _id: string;
  views: number | null;
} | null;
// Variable: FETCH_AUTHOR_BY_GITHUB_ID_QUERY
// Query: *[_type == 'author' && id == $id][0] {        _id,        id,        name,        username,        email,        image,        bio    }
export type FETCH_AUTHOR_BY_GITHUB_ID_QUERYResult = {
  _id: string;
  id: number | null;
  name: string | null;
  username: string | null;
...
// Variable: FETCH_AUTHOR_BY_ID_QUERY
// Query: *[_type == 'author' && _id == $id][0] {        _id,        id,        name,        username,        email,        image,        bio    }
export type FETCH_AUTHOR_BY_ID_QUERYResult = {
  _id: string;
  id: number | null;
  name: string | null;
  username: string | null;
...
// Variable: FETCH_STARTUPS_BY_AUTHOR_QUERY
...
export type FETCH_STARTUPS_BY_AUTHOR_QUERYResult = Array<{
  _id: string;
  title: string | null;
  slug: Slug | null;
  _createdAt: string;
...
// Variable: FETCH_PLAYLIST_BY_SLUG_QUERY
// Query: *[_type == 'playlist' && slug.current == $slug][0] {        _id,        title,        slug,        select[] -> {            _id,            _createdAt,            title,            slug,            author -> {                _id,                name,                slug,                image,                bio            },            views,            description,            category,            image,        },            }
export type FETCH_PLAYLIST_BY_SLUG_QUERYResult = {
  _id: string;
  title: string | null;
  slug: Slug | null;
  select: Array<{
...
declare module "@sanity/client" {
  interface SanityQueries {
    ...
    "\n    *[_type == 'author' && id == $id][0] {\n        _id,\n        id,\n        name,\n        username,\n        email,\n        image,\n        bio\n    }\n": FETCH_AUTHOR_BY_GITHUB_ID_QUERYResult;
    "\n    *[_type == 'author' && _id == $id][0] {\n        _id,\n        id,\n        name,\n        username,\n        email,\n        image,\n        bio\n    }\n": FETCH_AUTHOR_BY_ID_QUERYResult;
    "\n    *[_type == 'startup' && author._ref == $id] | order(_createdAt, desc) {\n        _id,\n        title,\n        slug,\n        _createdAt,\n        author -> {\n            _id,\n            name,\n            image,\n            bio\n        },\n        views,\n        description,\n        category,\n        image,\n    }\n": FETCH_STARTUPS_BY_AUTHOR_QUERYResult;
    "\n    *[_type == 'playlist' && slug.current == $slug][0] {\n        _id,\n        title,\n        slug,\n        select[] -> {\n            _id,\n            _createdAt,\n            title,\n            slug,\n            author -> {\n                _id,\n                name,\n                slug,\n                image,\n                bio\n            },\n            views,\n            description,\n            category,\n            image,\n        },\n        \n    }\n": FETCH_PLAYLIST_BY_SLUG_QUERYResult;
  }
}
